/*---------------------------------
 - Title: UI腳本生成工具
 - Created Date: 3/2/2025 2:03:26 AM
 - 注意事項:
...
namespace Game.UI
{
    public class Window_GamePlay : WindowBase
    {
        ...
        private void InitUIComponent()
        {
            ...
            GameJoyStick = UIComponentContainer[0].GetComponent<JoyStick>();
            // End InitUIComponent
        }
        ...
        {
            float angle = GameJoyStick.Angle;
            
            ServiceSystem.Instance.BattleService.SetInput(angle);
        }
